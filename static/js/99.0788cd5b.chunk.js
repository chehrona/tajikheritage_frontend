"use strict";(self.webpackChunktajikheritage_frontend_ts=self.webpackChunktajikheritage_frontend_ts||[]).push([[99],{5599:(e,r,i)=>{i.r(r),i.d(r,{default:()=>Mi});var t=i(5043),a=i(3216),d=i(215),o=i(7683),n=i(4946),l=i(910),s=i(5953),m=i(1529);const h=m.Ay.div`
    display: flex;
...
`,yr=m.Ay.div`
    width: calc(100% - 1rem);
`,br=e=>{let{text:r}=e;const{lang:i}=(0,d.X)(),[a,o]=(0,t.useState)(!0);return(0,t.useEffect)((()=>{o(!0)}),[i]),a?(0,j.jsxs)(gr,{children:[(0,j.jsx)(yr,{dangerouslySetInnerHTML:{__html:r}}),(0,j.jsx)(vr,{onClick:()=>o(!1),children:(0,j.jsx)(xr,{})})]}):(0,j.jsx)(ur,{onClick:()=>o(!0),children:(0,j.jsx)(wr,{})})},fr=m.Ay.div`
    background: var(--primary-black-color);
    position: relative;
    background-image: url(${"/customAssets/noise.png"});
