...
`;var v=a(579);const x=e=>{let{section:r}=e;const{lang:a}=(0,i.X)();return(0,v.jsx)(l.A,{page:r.link,type:"long",disabled:r.disabled,children:(0,v.jsxs)(u,{children:[(0,v.jsx)(m,{children:(0,v.jsx)(g,{$src:"https://api.thetajikheritage.com"+(null===r||void 0===r?void 0:r.cardImg[a])})}),(0,v.jsx)(p,{$length:null===r||void 0===r?void 0:r.cardTitle[a].length,children:null===r||void 0===r?void 0:r.cardTitle[a]})]})})};var f=a(6331),w=a(5452);const y=h.Ay.div`
...
`,b=e=>{let{page:r}=e;const{pathname:a}=(0,n.zy)(),{showToast:l}=(0,o.Y)(),{lang:h}=(0,i.X)(),[u,p]=(0,t.useState)([]),[m,g]=(0,t.useState)(null);return(0,d.J)(r,"landing",u),(0,t.useEffect)((()=>{(async()=>{try{const e=await(0,s.DL)(r);p(e.sections)}catch(m){const a=m;404===a.status?g(404):500===a.status&&l("E_500","error",r)}})()}),[a]),(0,v.jsxs)(t.Fragment,{children:[404===m?(0,v.jsx)(w.default,{}):null,(0,v.jsx)(c.A,{children:(0,v.jsx)(f.A,{children:u.length>0?(0,v.jsx)(y,{$center:u.length%3===0,children:null===u||void 0===u?void 0:u.map(((e,r)=>(0,v.jsx)(x,{section:e},e.cardTitle[h])))}):null})})]})}},910:(e,r,a)=>{a.d(r,{AN:()=>l,uu:()=>s,Gg:()=>o,DL:()=>d,c1:()=>c});var t=a(6213);const i=e=>{let r=null;return localStorage.getItem("th_Id")?r=localStorage.getItem("th_Id"):(r=e+"_"+Math.random().toString(36).substring(2,9),localStorage.setItem("th_Id",r)),r},n="https://api.thetajikheritage.com",d=async e=>{e||(e="");try{const r=i(e);return(await t.A.get(`${n}/${e}`,{params:{page:e,userId:r}})).data}catch(r){throw r}},o=async e=>{try{const r=i(e);return(await t.A.get(`${n}/${e}`,{params:{userId:r,page:e}})).data}catch(r){throw r}},s=async(e,r)=>{try{const a=i(`${r}${e}`);return(await t.A.get(`${n}/${r}`,{params:{id:e,page:`${r}/${e}`,userId:a}})).data}catch(a){throw a}},c=async e=>{try{const r=await t.A.get(`${n+e}`,{responseType:"arraybuffer"}),a=new Blob([r.data],{type:"application/pdf"});return URL.createObjectURL(a)}catch(r){throw r}},l=async e=>{try{return await t.A.post(`${n}/email`,{info:e})}catch(r){throw r}}},4330:e=>{e.exports=JSON.parse('{"WORDS_NOT_FOUND":{"tj":"\u042f\u0433\u043e\u043d \u043a\u0430\u043b\u0438\u043c\u0430 \u0451\u0444\u0442 \u043d\u0430\u0448\u0443\u0434","ru":"\u041d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e","us":"No words found","fa":"\u06cc\u06af\u0627\u0646 \u06a9\u0644\u0645\u0647 \u06cc\u0627\u0641\u062a \u0646\u0634\u062f"},"SEARCH_NOT_FOUND":{"us":"No items match your search","ru":"\u041f\u043e \u0432\u0430\u0448\u0435\u043c\u0443 \u0437\u0430\u043f\u0440\u043e\u0441\u0443 \u043d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e","tj":"\u0410\u0437 \u0440\u04ef\u0438 \u0434\u0430\u0440\u0445\u043e\u0441\u0442\u0438 \u0448\u0443\u043c\u043e \u0447\u0438\u0437\u0435 \u0451\u0444\u0442 \u043d\u0430\u0448\u0443\u0434","fa":"\u0627\u0632 \u0631\u0648\u06cc \u062f\u0631\u062e\u0648\u0627\u0633\u062a\u06cc \u0634\u0645\u0627 \u0686\u06cc\u0632\u06cc \u06cc\u0627\u0641\u062a \u0646\u0634\u062f"},"ARTICLE_UNAVAILABLE":{"us":"Article is not available yet","ru":"\u0421\u0442\u0430\u0442\u044c\u044f \u0435\u0449\u0435 \u043d\u0435 \u0434\u043e\u0441\u0442\u0443\u043f\u043d\u0430","tj":"\u041c\u0430\u049b\u043e\u043b\u0430 \u04b3\u0430\u043d\u04ef\u0437 \u0432\u0443\u04b7\u0443\u0434 \u043d\u0430\u0434\u043e\u0440\u0430\u0434","fa":"\u0645\u0642\u0627\u0644\u0647 \u0647\u0646\u0648\u0632 \u0648\u062c\u0648\u062f \u0646\u062f\u0627\u0631\u062f"},"PAGE_NOT_FOUND":{"us":"Page not found","ru":"\u0421\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u0430","tj":"\u0421\u0430\u04b3\u0438\u0444\u0430 \u0451\u0444\u0442 \u043d\u0430\u0448\u0443\u0434","fa":"\u0635\u062d\u06cc\u0641\u0647 \u06cc\u0627\u0641\u062a \u0646\u0634\u062f"},"E_500":{"us":"Internal server error","ru":"\u0412\u043d\u0443\u0442\u0440\u0435\u043d\u043d\u044f\u044f \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430","tj":"\u0425\u0430\u0442\u043e\u0433\u04e3 \u0431\u043e \u0441\u0435\u0440\u0432\u0435\u0440\u0438 \u0434\u043e\u0445\u0438\u043b\u04e3","fa":"\u062e\u0637\u0627\u06af\u06cc \u0628\u0627 \u0633\u0631\u0648\u0631\u06cc \u062f\u0627\u062e\u0644\u06cc"}}')}}]);
//# sourceMappingURL=115.99e3ff56.chunk.js.map