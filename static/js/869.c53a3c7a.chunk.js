(self.webpackChunktajikheritage_frontend_ts=self.webpackChunktajikheritage_frontend_ts||[]).push([[869],{5037:(e,t,r)=>{"use strict";r.r(t),r.d(t,{default:()=>j});var n=r(5043),a=r(9657),i=r(3216),s=r(215),o=r(7683),d=r(4946),c=r(910),m=r(4319),l=r(5452),p=r(4952),u=r(102),h=r(4414),v=r(8880),g=r(8044),x=r(1529);const f=x.Ay.div`
    font-weight: bold;
...
`;var b=r(579);const j=e=>{let{page:t}=e;const{id:r}=(0,i.g)(),{pathname:x}=(0,i.zy)(),{showToast:j}=(0,d.Y)(),{lang:A}=(0,s.X)(),[$,L]=(0,n.useState)(),[k,O]=(0,n.useState)(null),R=(0,a.Ub)({query:"(min-device-width: 481px) and (max-device-width: 1024px)"})?2.5:4;return(0,o.J)(t,"generic",$),(0,n.useEffect)((()=>{(async()=>{try{if(!r)return;const e=await(0,c.uu)(r,t);L(e)}catch(k){const r=k;404===r.status?O(404):500===r.status&&j("E_500","error",t)}})()}),[x]),(0,b.jsxs)(n.Fragment,{children:[404===k||null!==$&&void 0!==$&&$.disabled?(0,b.jsx)(l.default,{}):null,(0,b.jsx)(m.A,{children:(0,b.jsx)(g.A,{children:(0,b.jsx)(v.A,{children:$?(0,b.jsxs)(n.Fragment,{children:[(0,b.jsx)(f,{children:`${$.title[A]} (${$.syntax[A]})`}),(0,b.jsxs)(y,{children:[(0,b.jsx)(w,{children:$.transcript}),(0,b.jsx)(u.A,{data:$.audio})]}),$.desc[A].map(((e,t)=>(0,b.jsx)(h.A,{i:t,data:e,topLeftRad:R},`${null===$||void 0===$?void 0:$._id}_${t}`))),(0,b.jsx)(p.A,{data:$.references[A]})]}):null})})})]})}},4414:(e,t,r)=>{"use strict";r.d(t,{A:()=>L});var n=r(5043),a=r(2958),i=r(5953),s=r(9657),o=r(1529);const d=o.Ay.div`
    display: flex;
    align-items: center;
    position: relative;
    padding: var(--text-segment-gap) var(--page-padding);
...
`;var v=r(579);const g=e=>{let{subtitle:t,hasSlides:r,reverse:n=null}=e;const a=!!(0,s.Ub)({query:"(max-width: 480px)"})||!r,i=r?n:null;return(0,v.jsxs)(d,{$reverse:i,children:[(0,v.jsxs)(l,{$show:a,children:[(0,v.jsx)(p,{}),(0,v.jsx)(u,{})]}),(0,v.jsx)(h,{dangerouslySetInnerHTML:{__html:t}}),(0,v.jsxs)(m,{children:[(0,v.jsx)(u,{}),(0,v.jsx)(p,{})]})]})};var x=r(1070);const f=e=>{let{title:t,color:r,align:n}=e;return(0,v.jsx)(x.a,{$align:n,$color:r,children:t})},y=o.Ay.div`
    width: 100%;
    display: block;
    position: relative;
