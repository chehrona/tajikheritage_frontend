...
`;var h=a(579);const p=()=>{const{lang:e}=(0,t.Xe)();return(0,i.J)("reset"),(0,h.jsx)(o.A,{children:(0,h.jsx)(s,{children:(0,h.jsxs)(l,{children:[(0,h.jsx)(m,{children:"404"}),(0,h.jsx)(c,{children:d.PAGE_NOT_FOUND[e]})]})})})}},7683:(e,r,a)=>{a.d(r,{J:()=>n});var t=a(5043),i=a(215),d=a(910),o=a(2754);const n=(e,r,a)=>{const{title:n,setTitle:s}=(0,i.Xe)(),l="landing"===r?e:e.substring(0,e.indexOf("/")),m="middle"===r?e.substring(e.indexOf("_")+1):e.substring(e.indexOf("/")+1,e.length-1);(0,t.useEffect)((()=>{"reset"===e?s(o.El):(async()=>{try{const e=await(0,d.DL)(l);let a={...n};"landing"===r?c(a,e):h(a,e),s(a)}catch(e){s(o.El)}})()}),[e,a]);const c=(e,r)=>{const{header:a}=r;for(const t in n){const r=t;let i=[...n[r]];const d=[`${a[r].toUpperCase()}`,""];i[1]=d,e[r]=i}},h=(e,t)=>{const{header:i,sections:d}=t;null===d||void 0===d||d.forEach((t=>{const{link:d,cardTitle:o}=t;if(d===m)for(const s in n){const t=s;let d=[...n[t]],l=[];l="middle"===r?[`${i[t].toUpperCase()}`,`${void 0!==o[t]?o[t]:""}`]:[`${o[t].toUpperCase()}`,`${void 0!==(null===a||void 0===a?void 0:a.name[t])?null===a||void 0===a?void 0:a.name[t]:""}`],d[1]=l,e[t]=d}}))}}},4946:(e,r,a)=>{a.d(r,{Y:()=>s});var t=a(5043),i=a(1036),d=a(215),o=a(4330),n=a(3216);const s=()=>{const{lang:e}=(0,d.Xe)(),{pathname:r}=(0,n.zy)(),a=(0,t.useRef)({});return(0,t.useEffect)((()=>{Object.keys(a.current).forEach((r=>{const{key:t}=a.current[r],d=o[t][e];i.oR.update(r,{render:d,autoClose:2e3})}))}),[e]),(0,t.useEffect)((()=>{i.oR.dismiss()}),[r]),{showToast:(r,t,d)=>{const n=o[r][e];switch(a.current[d]={key:r},t){case"info":return i.oR.info(n,{toastId:d});case"success":return i.oR.success(n,{toastId:d});case"error":return i.oR.error(n,{toastId:d})}}}}},3880:(e,r,a)=>{a.r(r),a.d(r,{default:()=>S});var t=a(5043),i=a(3216),d=a(7683),o=a(4946),n=a(910),s=a(5260),l=a(215),m=a(844),c=a(1529);const h=c.Ay.div`
    width: 100%;
    height: 100%;
    color: var(--primary-white-color);
...
//# sourceMappingURL=880.702d944d.chunk.js.map