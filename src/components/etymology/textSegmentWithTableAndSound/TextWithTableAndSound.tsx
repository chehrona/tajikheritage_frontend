...
// Types
import { TextSegmentWithTableAndSoundProps } from './types/componentTypes';
...
const TextSegmentWithTableAndSound: React.FC<
    TextSegmentWithTableAndSoundProps
> = ({ data, id }) => {
...
export default TextSegmentWithTableAndSound;
